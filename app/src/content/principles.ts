...
export const PRINCIPLES: Principle[] = [
  ...
  { n: "04", r: "4", hue: 120, lead: 'Decompose until <span class="hl">delegable.</span>', sub: 'Small tasks survive async work, model changes, and team handoffs.', proof: 'aidd-dev:01-plan + 02-implement' },
  ...
  { n: "06", r: "6", hue: 200, lead: 'Capture learning for <span class="hl">reuse.</span>', sub: 'Each lesson becomes memory, a rule, a decision, or a skill others can use.', proof: 'aidd-context:05-learn' },
  ...
  { n: "11", r: "11", hue: 10, lead: 'Treat AI failure as <span class="hl">a signal.</span>', sub: 'When the model stalls, inspect scope, context, assumptions, and tests before pushing harder.', proof: 'aidd-dev:08-debug + aidd-refine:02' },
  { n: "12", r: "12", hue: 28, lead: 'Make the practice <span class="hl">transferable.</span>', sub: 'A shared method lets different people produce the same quality of code across tools.', proof: 'aidd-vcs:01 + 02 + 03' },
];
